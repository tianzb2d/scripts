...
def GetDirectory(benchmarks):
    if benchmarks == '1':
        directory = '/home/tianzb/gem5-gpu/benchmarks/rodinia/'
    elif benchmarks == '2':
        directory = '/home/tianzb/gem5-gpu/benchmarks/rodinia-omp/'
    elif benchmarks == '3':
        directory = '/home/tianzb/gem5-gpu/benchmarks/rodinia-nocopy/'
    return directory
...
def CreatRecord():
    ...
    source = '/home/tianzb/gem5-gpu/gem5/m5out/stats.txt'
    target_dir = '/home/tianzb/scripts/'
...
def RunBenchmark(directory, patt, benchmarks, cycles, source, target, target_benchmark):
    ...
    elif target_benchmark == 'nw' or target_benchmark == 'leukocyte' or target_benchmark == 'common' or  target_benchmark == 'particlefilter':
        benchmark = ''
    else:
